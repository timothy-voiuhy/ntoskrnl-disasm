IoReadPartitionTableEx proc near        ; DATA XREF: .pdata:000000014011C508↑o
...
; __unwind { // __GSHandlerCheck
                ...
                mov     ebx, eax
                test    eax, eax
                js      short loc_14088F62B
                mov     rdx, rdi
                lea     rcx, [rsp+1A8h+var_188]
                call    sub_1405C7408
                mov     ebx, eax

loc_14088F62B:                          ; CODE XREF: IoReadPartitionTableEx+5A↑j
                lea     rcx, [rsp+1A8h+var_188]
                mov     [rsp+1A8h+var_188], rsi
                call    sub_1405C6F44
                mov     eax, ebx
